...
@include('panel.navbar')
    ...
    {{$blog->id}}: <br>
    <a href="{{route('panel.blog.edit',$blog)}}">edit</a><br>
    <a href="{{route('panel.blog.categories',$blog)}}">دسته بندی های این بلاگ</a><br>
    <a href="{{route('panel.blog.related',$blog)}}">Related </a><br>
