...
@foreach($blogs as $blog)
    {{$blog->id}}: <br>
    <a href="{{route('panel.blog.show',$blog)}}">show</a>
    <form>
        @csrf
        Image:
        <input type="text" name="id" value="{{$blog->id}}">
        <input type="text" name="categoryId" value="{{$blogCategory->id}}">
        <input type="submit" value="حذف از این دسته بندی">
